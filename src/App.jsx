...
function App() {
  ...
  return (
    <div className='w-full h-screen bg-gray-50'>
      <header className='w-full md:h-24 bg-white shadow p-6 flex justify-between items-center'>
        <div>
        ...
        <div>
          <button className='bg-blue-600 rounded-full flex p-3.5 items-center gap-2.5 cursor-pointer'>
            <Plus color='white'/>
